...
const u8 gText_PokeSum_Controls_Page[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}CYCLE");
...
const u8 gText_LinkBattles[] = _("G5:L43   G6:L43   G7:L47   G8:L50");
const u8 gText_LinkCableBattles[] = _("LINK CABLE BATTLES");
const u8 gText_WinLossRatio[] = _("W:{CLEAR_TO 0x30}L:");
const u8 gText_PokemonTrades[] = _("E1:L54   E2:L56   E3:L58   E4:L60");
const u8 gText_UnionRoomTradesBattles[] = _("CHAMPION:L63");
const u8 gText_BerryCrushes[] = _("G1:L14   G2:L21   G3:L24   G4:L29");
